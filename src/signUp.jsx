    ...
    //         <div className="w-full lg:w-5/12 bg-white rounded-3xl shadow-xl p-8 lg:p-10 top-4">
    ...
    //                 className="pl-10 w-full border border-primary rounded-lg px-4 py-2 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-sky-500"
    //             />
    ...
    //         <h2 className="text-xl font-bold text-gray-900 mb-2">Choose how you'll be using LLHAR</h2>
...
const SignupPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // ✅ Create demo user (store in localStorage for demo)
    const demoUser = {
    ...
    alert(`Demo account created for ${formData.email} as ${selectedRole}`);

    // ✅ Navigate based on role
    if (selectedRole === 'tenant') navigate('/');
    else if (selectedRole === 'owner') navigate('/dashboard');
    else if (selectedRole === 'agency') navigate('/buy');
